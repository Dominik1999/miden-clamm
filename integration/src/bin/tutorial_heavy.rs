//! HEAVY-NOTE variant of tutorial_repro: identical except the note script
//! burns ~100k cycles in a dummy loop before incrementing, matching the
//! trace magnitude of the CLAMM pool network txs.
//! Original:
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let counter_code = include_str!("../../masm/tutorial/accounts/counter.masm");
    let script_code = include_str!("../../masm/tutorial/scripts/counter_script.masm");
    let network_note_code = include_str!("../../masm/tutorial/notes/network_increment_note_heavy.masm");
